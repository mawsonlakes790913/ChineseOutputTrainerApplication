...
「トレーニング（簡体中文）」「トレーニング（繁體中文）」はプルダウン形式とし、それぞれ以下の学習方法を選択できる。
...
「このアプリについて」を選択した場合はチュートリアル画面へ遷移する。
...
通常学習メニューで難易度、出題順、出題範囲などの条件を選択した後、通常学習問題画面へ遷移する。
...
AI出題メニューでは、AIによる問題生成に必要な出題条件を選択し、学習開始後はAI出題問題画面へ遷移する。
...
復習メニューでは理解度などの復習条件を指定し、復習開始後は復習問題画面へ遷移する。
